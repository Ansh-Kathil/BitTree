    ...
    <main>
      <section className="bg-[#F0F2BD]  min-h-[100vh] grid grid-cols-2">
        <div className=" flex items-center flex-col justify-center ml-[10vw] gap-4">
            ...
            <p className="text-[#4B352A] text-xl">BitLink is a simple, no-nonsense alternative to cluttered bio links. Create one clean page to share all your socials, projects, and content — without the bloat. Perfect for anyone who wants a fast, minimal, and personal way to connect everything they do.</p>
